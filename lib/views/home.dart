...
final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  ...
  void saveRideData() async {
    try {
      await FirebaseFirestore.instance.collection('rides').add({
        'userId': authController.myUser.value.id,
        'destination': {
      ...
      Get.snackbar('Error', 'Failed to book ride: $e');
    }
  }
  ...
  buildRideConfirmationSheet() {
              ...
              children: [
                ...
                MaterialButton(
                  onPressed: () {
                    ...
                    String fromAddress = sourceController.text;
    LatLng fromLocation = source;
    String toAddress = destinationController.text;
    LatLng toLocation = destination;

    // Call the saveBookingData method
    authController.saveBookingData(
      fromAddress,
      fromLocation,
      toAddress,
      toLocation
    ...
    // Close the bottom sheet or navigate to a new screen
    Get.back();
